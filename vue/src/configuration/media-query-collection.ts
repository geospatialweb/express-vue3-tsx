...
export default {
  ...
  // iPhone SE (2020) / 6 / 7 / 8 / 12 Mini / 13 Mini // Huawei P / Mate / Nova // Sony Xperia X / XZ / Z2 / Z3 / Z5
  ...
  // iPhone 6+ / 7+ / 8+ / X / XR / XS Max / 11 / 11 Pro / 11 Pro Max / 12 / 12 Pro / 12 Pro Max / 13 / 13 Pro / 13 Pro Max
  ...
  // Google Pixel / XL / 2 / 2XL / 3 / 3a / 3XL / 4 / 4a / 4XL / 5 / 6 / 6 Pro // Xiaomi Mi / Redmi
  '(max-width: 428px) and (max-height: 1024px)': {
    deckgl: 4.7,
    mapbox: 7.3,
    trail: 0.85
  },
